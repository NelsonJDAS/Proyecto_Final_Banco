...
Revision ID: 5fb386e6d002
Revises: 
Create Date: 2025-02-05 15:08:29.741211
...
def upgrade():
    ...
    sa.Column('rol', sa.Enum('usuario', 'administrador', name='rol_enum'), nullable=False),
