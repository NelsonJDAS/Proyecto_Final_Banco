...
const ContenedorPrincipalTransferencias = () => {
    ...
    return (
        <>
            ...
            <div className={`container contenedor-principal-transferencias text-dark ${userLoad ? "animacion-izq visible" : "animacion-izq"}`}>
                <div className="row">
                    ...
                    <div className={`my-md-2  col-lg-6 d-flex flex-column text-center ${userLoad ? "animacion-izq visible" : "animacion-izq"}`}>
