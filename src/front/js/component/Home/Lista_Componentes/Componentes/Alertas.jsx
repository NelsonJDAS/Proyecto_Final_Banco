...
const Alertas = () => {
    ...
    return (
        <div className={`bg-alertas animacion-contenedor align-content-center hover contenedor-componente-interactivo my-2 rounded text-center fw-bold ${store.borde} text-white d-flex flex-column`}>
